...
// Classes
private _dropClass  = "ic51_droidDespener_DropProxy_b1"; // falls
private _finalClass = "ic51_droidDespener_b1";           // tanky, destroyable
...
if (_unitClasses isEqualTo []) then {
    private _defaults = switch (_side) do {
        ...
        default {["ic51_opfor_unit_b1_standard"]};
    };
